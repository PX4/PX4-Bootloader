...
# define BOARD_SENSE_CLOCK_BIT          RCC_AHB1ENR_GPIOCEN
...
#if defined(INTERFACE_USB) && !defined(BOARD_SENSE_CLOCK_BIT)
#  define BOARD_SENSE_CLOCK_BIT RCC_AHB1ENR_GPIOAEN
#endif
