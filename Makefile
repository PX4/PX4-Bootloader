...
mavstation_bl: $(MAKEFILE_LIST)
	make -f Makefile.f1 LINKER_FILE=stm32f102.ld F1_APP_LOAD_ADDRESS=0x08004000 F1_APP_SIZE_MAX=0x17000 TARGET=mavstation INTERFACE=USB BOARD=MAVSTATION USBDEVICESTRING="\\\"MAVSTATION v0.1\\\"" USBPRODUCTID="0x0014"
