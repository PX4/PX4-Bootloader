...
mavstation_bl: $(MAKEFILE_LIST) $(LIBOPENCM3)
	make -f Makefile.f1 LINKER_FILE=8K-stm32f1.ld F1_APP_LOAD_ADDRESS=0x08002000 F1_APP_SIZE_MAX=0x1D000 TARGET=mavstation INTERFACE=USB BOARD=MAVSTATION USBDEVICESTRING="\\\"MAVSTATION v0.1\\\"" USBPRODUCTID="0x0014"
